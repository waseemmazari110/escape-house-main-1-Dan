    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg-secondary)]">
        <div className="text-center p-8 bg-white rounded-lg shadow-lg max-w-md">
          ...
          <h1 className="text-2xl font-bold text-[var(--color-text-primary)] mb-2">Access Restricted</h1>
          <p className="text-[var(--color-neutral-dark)] mb-4">Please sign in to access this page.</p>
        </div>
      </div>
    );
  }
