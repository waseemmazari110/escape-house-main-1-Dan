...
import { Check, ChevronRightIcon, Lightbulb, Users, Star } from "lucide-react";
...
export default function UnusualAndQuirkyPage() {
  const highlights = [
    "Unique properties from treehouses to converted barns",
    "One-of-a-kind settings for memorable celebrations",
    "Coastal retreats and countryside hideaways",
    "Perfect for Instagram-worthy moments",
    "Stand-out venues for special occasions"
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: "url('https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/8330e9be-5e47-4f2b-bda0-4162d899b6d9/generated_images/quirky-converted-barn-holiday-home-exter-11db9250-20251022191906.jpg')",
          }}
        >
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center">
          ...
          <nav className="inline-flex items-center gap-2 text-sm mb-6 bg-white/95 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
            ...
            <span className="text-[var(--color-neutral-dark)]">/</span>
            <span className="text-[var(--color-accent-gold)] font-semibold">Unusual & Quirky</span>
          </nav>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-10 shadow-2xl max-w-4xl mx-auto">
            <h1 className="mb-4 text-[var(--color-text-primary)]" style={{ fontFamily: "var(--font-display)" }}>
              Unusual & Quirky Holiday Homes
            </h1>
            <p className="text-xl text-[var(--color-neutral-dark)] max-w-3xl mx-auto">
              Unique group accommodation for celebrations with a difference
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="mb-6" style={{ fontFamily: "var(--font-display)" }}>
                Quirky Holiday Homes UK
              </h2>
              <p className="text-lg text-[var(--color-neutral-dark)] mb-8 leading-relaxed">
                Step outside the ordinary with our collection of unusual and quirky holiday homes. From converted lighthouses to stylish treehouses, these distinctive properties offer a truly unique backdrop for hen parties and group celebrations. Create unforgettable memories in settings as special as your occasion.
              </p>
            ...
            <div className="space-y-6">
              <div className="bg-[var(--color-bg-primary)] rounded-2xl p-8">
                <Lightbulb className="w-12 h-12 text-[var(--color-accent-sage)] mb-4" />
                <h3 className="text-3xl font-bold mb-2" style={{ fontFamily: "var(--font-display)" }}>
                  Unique Design
                </h3>
                <p className="text-[var(--color-neutral-dark)]">
                  Converted barns, treehouses, and one-of-a-kind architecture
                </p>
              </div>

              <div className="bg-[var(--color-bg-primary)] rounded-2xl p-8">
                <Star className="w-12 h-12 text-[var(--color-accent-gold)] mb-4" />
                <h3 className="text-3xl font-bold mb-2" style={{ fontFamily: "var(--font-display)" }}>
                  Memorable Stays
                </h3>
                <p className="text-[var(--color-neutral-dark)]">
                  Create unforgettable moments in truly special settings
                </p>
              </div>
              ...
              <div className="bg-[var(--color-bg-primary)] rounded-2xl p-8">
                ...
                <p className="text-[var(--color-neutral-dark)]">
                  Unique doesn't mean small - plenty of space for your group
                </p>
              </div>
            </div>
          </div>
